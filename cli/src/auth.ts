...
// Password hashing: PBKDF2-SHA256, 600k iterations (OWASP-recommended for SHA-256
// in 2024). The same algorithm runs in the Cloudflare Pages Function via
// Web Crypto, so hashes generated by the CLI verify directly on the edge.
